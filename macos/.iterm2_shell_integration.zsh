...
alias imgcat=${DOTFILES_DIR}/macos/.iterm2/imgcat;alias imgls=${DOTFILES_DIR}/macos/.iterm2/imgls;alias it2api=${DOTFILES_DIR}/macos/.iterm2/it2api;alias it2attention=${DOTFILES_DIR}/macos/.iterm2/it2attention;alias it2check=${DOTFILES_DIR}/macos/.iterm2/it2check;alias it2copy=${DOTFILES_DIR}/macos/.iterm2/it2copy;alias it2dl=${DOTFILES_DIR}/macos/.iterm2/it2dl;alias it2getvar=${DOTFILES_DIR}/macos/.iterm2/it2getvar;alias it2git=${DOTFILES_DIR}/macos/.iterm2/it2git;alias it2setcolor=${DOTFILES_DIR}/macos/.iterm2/it2setcolor;alias it2setkeylabel=${DOTFILES_DIR}/macos/.iterm2/it2setkeylabel;alias it2ul=${DOTFILES_DIR}/macos/.iterm2/it2ul;alias it2universion=${DOTFILES_DIR}/macos/.iterm2/it2universion
