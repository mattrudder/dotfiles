...
config.font = font_with_fallback(font_family, { weight = 'Regular' })
config.command_palette_font = config.font
config.font_rules = {
    -- Select a fancy italic font for italic text
    {
        italic = true,
        font = font_with_fallback(font_family, { weight = 'Regular', italic = true }),
    },
    ...
    {
        intensity = 'Bold',
        font = font_with_fallback(font_family, { weight = 'Medium' }),
    },

    -- For half-intensity text, use a lighter weight font
    {
        intensity = 'Half',
        font = font_with_fallback(font_family, { weight = 'Thin' }),
    },
}
